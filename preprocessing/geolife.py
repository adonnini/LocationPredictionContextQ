...
#AD - ADDED
    gap_threshold=24 * 60, include_last=True, print_progress=True, dist_threshold=5, time_threshold=30, n_jobs=-1
#    gap_threshold=24 * 60, include_last=True, print_progress=True, dist_threshold=5, time_threshold=45, n_jobs=-1
...
#    sp = sp.as_staypoints.create_activity_flag(method="time_threshold", time_threshold=38)
#    sp = sp.as_staypoints.create_activity_flag(method="time_threshold", time_threshold=25)
...
#AD - ADDED
    print("LocationPrediction - preprocessing - geolife - 0 - len(train_data) - ",len(train_data))
    print("LocationPrediction - preprocessing - geolife - 0 - len(test_data) - ",len(test_data))
    print("LocationPrediction - preprocessing - geolife - 0 - len(vali_data) - ",len(vali_data))
...
#AD - ADDED
    print("LocationPrediction - preprocessing - geolife - 1 - len(train_data) - ",len(train_data))
    print("LocationPrediction - preprocessing - geolife - 1 - len(test_data) - ",len(test_data))
    print("LocationPrediction - preprocessing - geolife - 1 - len(vali_data) - ",len(vali_data))
