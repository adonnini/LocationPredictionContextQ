...
def calculate_user_quality(sp, trips, file_path, quality_filter):
    ...
    if "min_thres" in quality_filter:
        end_period = datetime.datetime(2024, 12, 31)
        print("min_thres")
...
#AD - ADDED
    print("LocationPrediction - preprocessing - utils.py - split_dataset - 0 - totalData - ",totalData)
    
    totalData = totalData.groupby("user_id",group_keys=False).apply(_get_split_days_user)
    
#AD - ADDED
    print("LocationPrediction - preprocessing - utils.py - split_dataset - 1 - totalData - ",totalData)
...
#AD - ADDED
    print("LocationPrediction - preprocessing - utils.py - _get_split_days_user - maxDay - ",maxDay)
    print("LocationPrediction - preprocessing - utils.py - _get_split_days_user - train_split - ",train_split)
    print("LocationPrediction - preprocessing - utils.py - _get_split_days_user - validation_split - ",validation_split)
...
def get_valid_sequence(input_df, previous_day=30):
